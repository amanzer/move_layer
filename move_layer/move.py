...
class Move:
    ...
    def execute(self):
        ...
        if not self.ran_once:
            ...
            start_frame = 0
            self.move_layer_handler = MoveLayerHandler(self.iface, connection_params, self.tm,LIMIT, TIME_DELTA_SIZE, PERCENTAGE_OF_OBJECTS,SRID, GRANULARITY, start_time_delta_key, start_frame)
